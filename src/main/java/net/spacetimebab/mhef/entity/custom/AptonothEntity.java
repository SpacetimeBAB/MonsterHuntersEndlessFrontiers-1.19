...
public class AptonothEntity extends TamableMonster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public AptonothEntity(EntityType<? extends TamableMonster> entityType, Level level) {
