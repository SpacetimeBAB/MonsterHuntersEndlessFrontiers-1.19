...
public class PopoEntity extends TamableMonster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public PopoEntity(EntityType<? extends TamableMonster> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder attributes() {
        return Mob.createMobAttributes()
                ...
                .add(ElementAttributes.ICE_RESISTANCE,15D)
    ...
    class PopoEntityMeleeGoal extends MeleeAttackGoal {
        public PopoEntityMeleeGoal() {
            super(PopoEntity.this, 1.25D, true);
        }
        ...
        protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
            ...
            if (pDistToEnemySqr <= d0 && this.isTimeToAttack()) {
                ...
                PopoEntity.this.setStanding(false);
                ...
                if (this.getTicksUntilNextAttack() <= 10) {
                    PopoEntity.this.setStanding(true);
                }
            } else {
                this.resetAttackCooldown();
                PopoEntity.this.setStanding(false);
