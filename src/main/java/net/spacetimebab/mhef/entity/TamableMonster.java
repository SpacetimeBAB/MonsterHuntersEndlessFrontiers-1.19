...
public abstract class TamableMonster extends TamableAnimal implements OwnableEntity {
    ...
    protected TamableMonster(EntityType<? extends net.minecraft.world.entity.TamableAnimal> p_21803_, Level p_21804_) {
